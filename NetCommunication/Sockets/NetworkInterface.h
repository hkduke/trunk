...
class Foundation_API NetworkInterface
...
public:
	...
	typedef Tuple<IPAddress, IPAddress, IPAddress> AddressTuple;
...
inline bool NetworkInterface::operator == (const NetworkInterface& other) const
{
 ...
 Foundation_API std::ostream& operator << (std::ostream& ostr, const NetCom::NetworkInterface::MACAddress& addr);
