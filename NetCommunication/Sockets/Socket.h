...
public:
	...
	void getOption(int level, int option, Timespan& value) const;
		/// Returns the value of the socket option 
		/// specified by level and option.
...
inline void Socket::setOption(int level, int option, const Timespan& value)
{
	_pImpl->setOption(level, option, value);
}
