...
class Foundation_API SocketAddressImpl : public RefCountedObject
{
public:
...
class Foundation_API IPv4SocketAddressImpl: public SocketAddressImpl
{
public:
...
class Foundation_API IPv6SocketAddressImpl: public SocketAddressImpl
{
public:
...
class Foundation_API LocalSocketAddressImpl: public SocketAddressImpl
{
public:
