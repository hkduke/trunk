...
class Foundation_API SocketStreamBuf: public BufferedBidirectionalStreamBuf
...
class Foundation_API SocketIOS: public virtual std::ios
...
class Foundation_API SocketOutputStream: public SocketIOS, public std::ostream
...
class Foundation_API SocketInputStream: public SocketIOS, public std::istream
...
class Foundation_API SocketStream: public SocketIOS, public std::iostream
