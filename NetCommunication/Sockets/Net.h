...
void Foundation_API initializeNetwork();
	/// Initialize the network subsystem.
	/// (Windows only, no-op elsewhere)


void Foundation_API uninitializeNetwork();
...
extern "C" const struct Foundation_API NetworkInitializer pocoNetworkInitializer;
