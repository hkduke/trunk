...
using NetCom::Mutex;
using NetCom::NotFoundException;
using NetCom::SyntaxException;
using NetCom::CircularReferenceException;
using NetCom::NumberParser;
using NetCom::NumberFormatter;
using NetCom::icompare;
...
{
	throw NetCom::NotImplementedException("removeRaw()");
}
