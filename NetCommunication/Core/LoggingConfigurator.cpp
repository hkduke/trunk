...
using NetCom::Formatter;
using NetCom::PatternFormatter;
using NetCom::Channel;
using NetCom::FormattingChannel;
using NetCom::Logger;
using NetCom::LoggingRegistry;
using NetCom::LoggingFactory;
